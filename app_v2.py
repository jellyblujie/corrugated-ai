...
[data-testid="stAppViewContainer"] {
    background: linear-gradient(180deg, #eefbf3 0%, #f7f8f7 45%, #f7f8f7 100%);
}
...
/* make upload/camera widgets fit mobile */
...
def cover_page():
    ...
    st.markdown(
        "<div class='powered'>🛡️ Powered by AI Vision</div>",
        unsafe_allow_html=True
    )
...
def result_page():
    ...
    if st.session_state.result_img is not None:
        st.markdown("<div class='result-img'>", unsafe_allow_html=True)
